...
RELEASE_URL = "https://github.com/gbrouwer/Hemerodromos/releases/tag/v0.1.0-beta.1"
VST3_DOWNLOAD_URL = (
    "https://github.com/gbrouwer/Hemerodromos/releases/download/"
    "v0.1.0-beta.1/Hemerodromos-Drone-v0.1.0-beta.1-macos-arm64-vst3.zip"
)
STANDALONE_DOWNLOAD_URL = (
    "https://github.com/gbrouwer/Hemerodromos/releases/download/"
    "v0.1.0-beta.1/Hemerodromos-Drone-v0.1.0-beta.1-macos-arm64-standalone.zip"
)
...
<div style="display: flex; flex-wrap: wrap; gap: 0.75rem; justify-content: center; margin: -0.5rem auto 2rem;">
  <a href="{VST3_DOWNLOAD_URL}" style="display: inline-block; padding: 0.72rem 1rem; border-radius: 8px; background: #111827; color: #fff; font-weight: 700; text-decoration: none;">Download VST3</a>
  <a href="{STANDALONE_DOWNLOAD_URL}" style="display: inline-block; padding: 0.72rem 1rem; border-radius: 8px; background: #374151; color: #fff; font-weight: 700; text-decoration: none;">Download Standalone</a>
  <a href="{RELEASE_URL}" style="display: inline-block; padding: 0.72rem 1rem; border-radius: 8px; border: 1px solid #6b7280; color: inherit; font-weight: 700; text-decoration: none;">Release Notes</a>
</div>
